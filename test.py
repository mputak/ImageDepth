...
class Generator:
    def __init__(self, prompt, filename):
        ...
        self.image = self.pipe(prompt=prompt, image=self.init_image, negative_prompt=self.n_propmt, strength=self.strength).images[0]

#TODO: - make GUI prettier by doing .grid or .place instead of .pack
#      - add preview img option
#      - explore more than 1 img generated from Generator
class App(ctk.CTk):
    def __init__(self):
